...
<div class="space-y-2">
    ...
    <input {{ $attributes->merge([
        'class' => 'block w-full px-4 py-3 bg-gray-800/80 border border-red-500/40 rounded-lg text-white placeholder-gray-300 backdrop-blur-sm focus:ring-2 focus:ring-red-500 focus:border-red-500 hover:border-red-500/60 transition-all duration-200 ' . ($error ? 'border-red-500 ring-2 ring-red-500/50' : '')
    ]) }}>
