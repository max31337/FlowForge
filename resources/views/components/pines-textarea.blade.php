...
<div class="space-y-2">
    ...
    <textarea {{ $attributes->merge([
        'rows' => $rows,
        'class' => 'block w-full px-4 py-3 rounded-lg backdrop-blur-sm transition-all duration-200 resize-none '
            ...
            . 'dark:bg-gray-800/80 dark:text-white dark:placeholder-gray-300 dark:border-red-500/40 '
